...
namespace JWMaps.Controllers
{
    public class AdminController : Controller
    {
        ...
        #region public ActionResult AdminRoles(string searchStringUserNameOrEmail)
        public ActionResult AdminRoles(string searchStringUserNameOrEmail, string currentFilter, int? page)
        {
            try
            {
                int intPage = 1;
        ...
        public ActionResult DeleteRole(string UserName, string RoleName)
        {
            try
            {
                ...
                if (UserName.ToLower() ==
                    this.User.Identity.Name.ToLower() && RoleName == JWMaps.Models.RoleName.CanAdministrate)
                {
                    ModelState.AddModelError(string.Empty,
